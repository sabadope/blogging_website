...
<section class="accounts">
   ...
   <?php
      ...
      <div class="box">
        ...
        <p> total messages : <span><?= $numbers_of_messages; ?></span> </p>
        <ul class="message-list">
            <!-- Your message list items here -->
            <?php while($message = $select_messages->fetch(PDO::FETCH_ASSOC)){ ?>
               <li style="list-style-type: none;"><?= (isset($message['message_content'])) ? $message['message_content'] : ''; ?></li>
            <?php } ?>
         </ul>
      </div>
      <?php
