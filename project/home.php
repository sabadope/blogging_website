...
// Set a message in the session if it hasn't been set yet (for example, on page refresh)
if (!isset($_SESSION['message'])) {
    // Set an info message with a link
    $_SESSION['message'] = [
        'type' => 'info',
        'content' => 'A new updated version is available, <a href="updated_home.php">click here</a> to see the changes!'
    ];
}
...
if (isset($_SESSION['message'])) {
    ...
    // After showing the message, you can clear it (to prevent it from showing on next reload)
    unset($_SESSION['message']);
}

// Continue with other includes or logic
